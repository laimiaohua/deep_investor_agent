...
def mohnish_pabrai_agent(state: AgentState, agent_id: str = "mohnish_pabrai_agent"):
    ...
    for ticker in tickers:
        ...
        metrics = get_financial_metrics(ticker, end_date, period="annual", limit=8, api_key=api_key, cn_api_key=cn_api_key, massive_api_key=massive_api_key, use_openbb=use_openbb)
